...
def main():
    ...
    for epoch in range(epochs):
        ...
        if epoch % 1 == 0:
            ...
            if val_acc > best_acc:
                ...
                torch.save(model.state_dict(), 'SENET_154_0427.mdl')
    ...
    train_accs_y1.to_csv("train_accs_senet_y1_2021_0426.csv")

    y2 = val_accs
    val_accs_y2 = pd.DataFrame(val_accs)
    val_accs_y2.to_csv("val_accs_senet_y2_2021_0426.csv")

    y3 = train_losses
    train_losses_y3 = pd.DataFrame(train_losses)
    train_losses_y3.to_csv("train_losses_senet_y3_2021_0426.csv")


    y4 = val_losses

    val_losses_y4 = pd.DataFrame(val_losses)
    val_losses_y4.to_csv("val_losses_senet_y4_2021_0426.csv")
    # y2 = Loss_list
    plt.subplot(2, 2, 1)
    ...
    plt.savefig("SENET_154_0427_accuracy_loss.pdf")
    plt.savefig("RSENET_154_0427_accuracy_loss.svg")
    plt.show()

    model.load_state_dict(torch.load('SENET_154_0427.mdl'))
